									...
									?>
										<tr class="item-row">
                                            ...
                                            <input hidden type="number" min="1" step="any" name="qty[]" value="<?php echo $invent[$row['id']]['qty'] ?>" class="text-right">
                                                <p class="text-right"><?php echo $invent[$row['id']]['qty'] ?></p>
											</td>
											<td>
                                            <input hidden type="number" min="1" step="any" name="price[]" value="<?php echo $invent[$row['id']]['price'] ?>" class="text-right">
                                                <p class="text-right"><?php echo $invent[$row['id']]['price'] ?></p>
											</td>
											<td>
